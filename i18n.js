var I18N = {
	'en': {
		...
		'howto-1': "&#x2022; To place currents, use left click for a current to us or right click for a current from us. The absolute value of the current is controlled by the slider above.",
		'howto-2': "&#x2022; To move currents, drag them around by their colored part using the left mouse button.",
		'howto-3': "&#x2022; To remove currents, right click on their colored part.",
		'equipot-summary': "Equipotential lines",
		'check_equipot': " Show",
		'slider_equipot': "Density",
		'slider_equipot_d': "Opacity",
		'slider_equipot_t': "Thickness",
		'E-summary': "Msgnetic field direction",
		'check_E': " Show",
		'slider_E': "Size",
		'slider_E_d': "Opacity",
		...
		'chargeinitial': " 2.00 A",
		'chargeunit': " A",
		'rendered': 'Image rendered (%time% ms)',
		'rendering': 'Rendering...',
		'clear': 'Delete currents',
		'reset': 'Reset all settings to default',
		'clear_msg': 'Delete existing currents? This action cannot be undone',
